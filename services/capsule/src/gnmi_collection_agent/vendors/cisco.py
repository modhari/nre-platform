...
Notes:
  NX-OS EVPN OpenConfig coverage is available from NX-OS 9.3+.
  MAC mobility sequence numbers are available via OpenConfig MAC table.
  ESI paths require NX-OS 10.2+ with OpenConfig EVPN extension.
"""
