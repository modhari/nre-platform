...
This is the decision, planning, state, and memory mode for the validated BGP diagnostics pipeline.
...
- classifies the plan as new, unchanged, or materially changed
...
- `NRE_AGENT_APPROVAL_DIR=/tmp/nre_agent_approvals`
- `NRE_AGENT_PLAN_MEMORY_DIR=/tmp/nre_agent_plan_memory`
